...
public class PromotionInstance {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((businessEstablishment == null) ? 0 : businessEstablishment.hashCode());
        result = prime * result + ((maxClientsAllowed == null) ? 0 : maxClientsAllowed.hashCode());
        result = prime * result + ((promotionDescription == null) ? 0 : promotionDescription.hashCode());
        result = prime * result + ((promotionValidDate == null) ? 0 : promotionValidDate.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (businessEstablishment == null) {
            if (other.businessEstablishment != null) return false;
        } else if (!businessEstablishment.equals(other.businessEstablishment)) return false;
        if (maxClientsAllowed == null) {
            if (other.maxClientsAllowed != null) return false;
        } else if (!maxClientsAllowed.equals(other.maxClientsAllowed)) return false;
        if (promotionDescription == null) {
            if (other.promotionDescription != null) return false;
        } else if (!promotionDescription.equals(other.promotionDescription)) return false;
        if (promotionValidDate == null) {
            if (other.promotionValidDate != null) return false;
        } else if (!promotionValidDate.equals(other.promotionValidDate)) return false;
        return true;
    }
