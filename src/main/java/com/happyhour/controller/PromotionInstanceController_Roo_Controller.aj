...
privileged aspect PromotionInstanceController_Roo_Controller {
    
    @Autowired
    PromotionInstanceService PromotionInstanceController.promotionInstanceService;
    
    @Autowired
    BusinessEstablishmentService PromotionInstanceController.businessEstablishmentService;
    
    @Autowired
    PromotionDescriptionService PromotionInstanceController.promotionDescriptionService;
    
    @Autowired
    PromotionRequestService PromotionInstanceController.promotionRequestService;
    
    @RequestMapping(method = RequestMethod.POST, produces = "text/html")
    public String PromotionInstanceController.create(@Valid PromotionInstance promotionInstance, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String PromotionInstanceController.createForm(Model uiModel) {
        populateEditForm(uiModel, new PromotionInstance());
        return "promotioninstances/create";
    }
    
    @RequestMapping(value = "/{id}", produces = "text/html")
    public String PromotionInstanceController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String PromotionInstanceController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String PromotionInstanceController.update(@Valid PromotionInstance promotionInstance, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, promotionInstance);
    ...
    public String PromotionInstanceController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, promotionInstanceService.findPromotionInstance(id));
        return "promotioninstances/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String PromotionInstanceController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void PromotionInstanceController.addDateTimeFormatPatterns(Model uiModel) {
    ...
    void PromotionInstanceController.populateEditForm(Model uiModel, PromotionInstance promotionInstance) {
    ...
    String PromotionInstanceController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
